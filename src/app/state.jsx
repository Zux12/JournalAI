...
export function ProjectProvider({ children }){
  ...
  const value = { project, update, setStyleId, setMetadata, setPlanner, setSectionDraft, setSectionDraftRaw, setSectionNotes, setSectionCitedKeys, setSources, setReferences };
